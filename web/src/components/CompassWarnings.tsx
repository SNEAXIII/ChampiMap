...
export function CompassWarnings({ heading, active }: Props) {
  ...
  return (
    <div className="pointer-events-none absolute top-10 left-1/2 z-20 max-w-[calc(100%-1.5rem)] -translate-x-1/2 rounded-lg bg-amber-100 px-3 py-2 text-center text-sm font-medium text-amber-900 shadow">
